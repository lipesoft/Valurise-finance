...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="pt-BR" className={jakarta.variable}><body>{children}<CookieConsent /></body></html>}
