      ...
      execute: async ({ period }) => {
        ...
        return formatValData({
          ...
          indicators: {
            ...
            previousPeriodRevenue: snapshot.previousPeriodRevenue,
            actualVsPreviousPercent: snapshot.actualVsPreviousPercent,
            previousComparisonLabel: snapshot.previousComparisonLabel,
          },
